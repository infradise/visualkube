...
For developers and operators who need to verify installation environments, the following tables provide a complete breakdown of supported operating systems, browsers, IDEs, and CPU architectures.  
Use this section to confirm compatibility before deploying Visualkube in your environment.
...
### Web
Run Visualkube directly in your browser using WebAssembly (WASM).  
This option requires no installation and works across major browsers.
...
### Browser Extension
Install Visualkube as a browser extension for seamless cluster management within your daily browsing workflow.  
...
### IDE Integration
Boost productivity by integrating Visualkube into your favorite IDE.  
Whether you use VS Code, JetBrains, or other supported environments, the table shows compatibility across architectures.
...
### Mobile
Manage clusters on the go with Visualkube’s mobile apps for iOS and Android.  
This section details supported architectures for each platform.
...
### Desktop
For full-featured local management, Visualkube provides desktop applications across macOS, Windows, and Linux.  
The table below outlines CPU and OS compatibility.
